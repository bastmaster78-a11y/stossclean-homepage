...
export const PROCESS_STEPS: ProcessStep[] = [
  { step: 1, icon: PhoneCall, title: "상담", description: "전화 또는 온라인으로 원하시는 청소 서비스를 편하게 상담받으세요." },
  { step: 2, icon: FileText, title: "견적", description: "공간 정보를 바탕으로 투명한 정찰제 견적을 안내해드립니다." },
  { step: 3, icon: CalendarCheck, title: "방문", description: "예약된 일정에 맞춰 전문 인력이 정확한 시간에 방문합니다." },
  { step: 4, icon: Sparkles, title: "청소", description: "표준 매뉴얼과 전용 장비로 구석구석 꼼꼼하게 작업합니다." },
  { step: 5, icon: Search, title: "검수", description: "작업 완료 후 담당자가 체크리스트에 따라 꼼꼼히 검수합니다." },
  { step: 6, icon: PartyPopper, title: "완료", description: "고객님의 확인과 만족으로 모든 서비스가 마무리됩니다." },
];

export const SERVICE_SCOPE: ScopeItem[] = [
  { icon: UtensilsCrossed, title: "주방", description: "후드·인덕션·싱크대 기름때와 냄새까지 완전히 제거합니다." },
  { icon: Bath, title: "욕실", description: "곰팡이와 물때, 배수구까지 위생적으로 새것처럼 관리합니다." },
  { icon: Sofa, title: "거실", description: "바닥 코팅부터 몰딩 먼지까지 생활 공간을 쾌적하게 만듭니다." },
  { icon: BedDouble, title: "방", description: "수납장 내부와 창틀까지 세심하게 살펴 깨끗하게 정리합니다." },
  { icon: TreePine, title: "베란다", description: "묵은 먼지와 배수구 이물질을 제거해 환기가 잘 되게 합니다." },
  { icon: DoorOpen, title: "현관", description: "신발장 내부와 바닥 타일까지 첫인상부터 깔끔하게 완성합니다." },
];
