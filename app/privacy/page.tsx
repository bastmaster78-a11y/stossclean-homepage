...
export const metadata: Metadata = {
  title: "개인정보처리방침",
  description: `${SITE.name} 개인정보처리방침 안내 페이지입니다.`,
...
const SECTIONS = [
  ...
  {
    title: "7. 개인정보 보호책임자",
    content: `개인정보 관련 문의는 아래 연락처로 접수해주시기 바랍니다. 이메일: ${SITE.email} / 전화: ${SITE.phone}`,
  },
];
    ...
    <section className="py-24">
      <Container className="max-w-3xl">
        ...
        <p className="mt-4 text-sm leading-relaxed text-slate-500">
          {SITE.name}({SITE.nameEn})은(는) 이용자의 개인정보를 소중히 다루며, 관련 법령을
          준수하기 위해 다음과 같이 개인정보처리방침을 수립·공개합니다.
        </p>
